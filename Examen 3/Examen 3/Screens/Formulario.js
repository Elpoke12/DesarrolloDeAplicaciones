...
const validations =Yup.object().shape({
    id:Yup.number().typeError('Este campo es numérico').max(9999,"Número muy grande").required('Obligatorio'),
    cantidad:Yup.number().typeError('Este campo es numérico').max(9999,"Número muy grande").required('Obligatorio'),
    precio:Yup.number().typeError('Este campo es numérico').max(9999,"Número muy grande").required('Obligatorio'),
